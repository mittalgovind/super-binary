...
#
# Find gadgets from the given set which are already present in the binary.
# This is largely identical to get_patch_addr_mapping.py.
#
...
def main():
    ...
    for g in gadgets:
        ...
        try:
            ...
            # Gadget does not exist in the given binary.
            pass

    pdb.set_trace()
    print "found %d existing gadgets" % (len(addr_map))
